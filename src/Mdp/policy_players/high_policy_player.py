...
class HighPolicyPlayer:
    ...
    def __init__(self, file_metadata: dict, model:AtHighMdpModel, probabilities_array: np.ndarray):
        """

        :param file_metadata: metadata stating who is high and who is low
        :param probabilities_array: (4x4) probability matrix from TransitionCountingTranslator
        """
        self.model = model
    ...
    def random_next_state(self, model_current_state:int, agent_action_number:int):
        ...
        probability_matrix = self.probabilities_array
