...
class AtHighModelValueIteration:
    """
    Uses at high mdp model to calculate rewards
    """
    def __init__(
        self, model: #TODO proper model
         , theta=0.0001, discount_factor=0.95
    ):
        self.theta = theta
            ...
            for s in range(self.n_s):
                ...
                for a in range(self.n_a):
                    for prob, next_state in self.G[s][a]:
                        # TODO SELECT PROPER REWARD FOR EACH STATE
